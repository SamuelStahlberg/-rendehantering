...
// Kontrollerar om användaren är inloggad som kund
if (!isset($_SESSION['customer_logged_in']) || $_SESSION['customer_logged_in'] !== true) {
    header("Location: login.php"); // Omdirigerar till inloggningssidan om användaren inte är inloggad
    exit();
}
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Lägger till ticketen i databasen
