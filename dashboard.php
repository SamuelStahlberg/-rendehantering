...
// Kontrollerar om användaren är inloggad som admin
if (!isset($_SESSION['admin_logged_in']) || $_SESSION['admin_logged_in'] !== true) {
    header("Location: admin.php"); // Omdirigerar till admin inloggningssidan om användaren inte är inloggad
    exit();
}
...
<form action="start.php" method="get">
    ...
    <!-- funktion för att visa/dölja ticket detaljer -->
    <script>
